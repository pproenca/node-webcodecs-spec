...
> From [HEVC (H.265) Registration](https://www.w3.org/TR/webcodecs-hevc-codec-registration/)
...
All of the text of this specification is normative except sections explicitly marked as non-normative, examples, and notes. [\[RFC2119\]](https://www.w3.org/TR/webcodecs-hevc-codec-registration/#biblio-rfc2119)

Examples in this specification are introduced with the words “for example” or are set apart from the normative text with `class="example"`, like this:

[](https://www.w3.org/TR/webcodecs-hevc-codec-registration/#w3c-example)
...
- [annexb](https://www.w3.org/TR/webcodecs-hevc-codec-registration/#dom-hevcbitstreamformat-annexb), in § 5.2
- [format](https://www.w3.org/TR/webcodecs-hevc-codec-registration/#dom-hevcencoderconfig-format), in § 5.1
- ["hevc"](https://www.w3.org/TR/webcodecs-hevc-codec-registration/#dom-hevcbitstreamformat-hevc), in § 5.2
- hevc
  - [dict-member for VideoEncoderConfig](https://www.w3.org/TR/webcodecs-hevc-codec-registration/#dom-videoencoderconfig-hevc), in § 5
  - [dict-member for VideoEncoderEncodeOptions](https://www.w3.org/TR/webcodecs-hevc-codec-registration/#dom-videoencoderencodeoptions-hevc), in § 6
  - [enum-value for HevcBitstreamFormat](https://www.w3.org/TR/webcodecs-hevc-codec-registration/#dom-hevcbitstreamformat-hevc), in § 5.2
- [HevcBitstreamFormat](https://www.w3.org/TR/webcodecs-hevc-codec-registration/#enumdef-hevcbitstreamformat), in § 5.2
- [HevcEncoderConfig](https://www.w3.org/TR/webcodecs-hevc-codec-registration/#dictdef-hevcencoderconfig), in § 5.1

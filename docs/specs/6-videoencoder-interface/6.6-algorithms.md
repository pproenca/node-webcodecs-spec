...
1.  For each output in outputs:
    ...
    7.  If encoderConfig.[`scalabilityMode`](#dom-videoencoderconfig-scalabilitymode) describes multiple [temporal layers](#temporal-layer):
        ...
        2.  Let temporal\_layer\_id be the zero-based index describing the temporal layer for output.
            
        3.  Assign temporal\_layer\_id to svc.[`temporalLayerId`](#dom-svcoutputmetadata-temporallayerid).

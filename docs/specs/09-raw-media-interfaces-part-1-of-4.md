...
```webidl
\[[Exposed](https://webidl.spec.whatwg.org/#Exposed)\=(Window,DedicatedWorker), [Serializable](https://html.spec.whatwg.org/multipage/structured-data.html#serializable), [Transferable](https://html.spec.whatwg.org/multipage/structured-data.html#transferable)\]
interface `AudioData` {
  [constructor](https://www.w3.org/TR/webcodecs/#dom-audiodata-audiodata)([AudioDataInit](https://www.w3.org/TR/webcodecs/#dictdef-audiodatainit) `init`);

  readonly attribute [AudioSampleFormat](https://www.w3.org/TR/webcodecs/#enumdef-audiosampleformat)? [format](https://www.w3.org/TR/webcodecs/#dom-audiodata-format);
  readonly attribute [float](https://webidl.spec.whatwg.org/#idl-float) [sampleRate](https://www.w3.org/TR/webcodecs/#dom-audiodata-samplerate);
  readonly attribute [unsigned long](https://webidl.spec.whatwg.org/#idl-unsigned-long) [numberOfFrames](https://www.w3.org/TR/webcodecs/#dom-audiodata-numberofframes);
  readonly attribute [unsigned long](https://webidl.spec.whatwg.org/#idl-unsigned-long) [numberOfChannels](https://www.w3.org/TR/webcodecs/#dom-audiodata-numberofchannels);
  readonly attribute [unsigned long long](https://webidl.spec.whatwg.org/#idl-unsigned-long-long) [duration](https://www.w3.org/TR/webcodecs/#dom-audiodata-duration);  // microseconds
  readonly attribute [long long](https://webidl.spec.whatwg.org/#idl-long-long) [timestamp](https://www.w3.org/TR/webcodecs/#dom-audiodata-timestamp);          // microseconds

  [unsigned long](https://webidl.spec.whatwg.org/#idl-unsigned-long) [allocationSize](https://www.w3.org/TR/webcodecs/#dom-audiodata-allocationsize)([AudioDataCopyToOptions](https://www.w3.org/TR/webcodecs/#dictdef-audiodatacopytooptions) `options`);
  [undefined](https://webidl.spec.whatwg.org/#idl-undefined) [copyTo](https://www.w3.org/TR/webcodecs/#dom-audiodata-copyto)([AllowSharedBufferSource](https://webidl.spec.whatwg.org/#AllowSharedBufferSource) `destination`, [AudioDataCopyToOptions](https://www.w3.org/TR/webcodecs/#dictdef-audiodatacopytooptions) `options`);
  [AudioData](https://www.w3.org/TR/webcodecs/#audiodata) [clone](https://www.w3.org/TR/webcodecs/#dom-audiodata-clone)();
  [undefined](https://webidl.spec.whatwg.org/#idl-undefined) [close](https://www.w3.org/TR/webcodecs/#dom-audiodata-close)();
};

dictionary `AudioDataInit` {
  required [AudioSampleFormat](https://www.w3.org/TR/webcodecs/#enumdef-audiosampleformat) `format`;
  required [float](https://webidl.spec.whatwg.org/#idl-float) `sampleRate`;
  \[[EnforceRange](https://webidl.spec.whatwg.org/#EnforceRange)\] required [unsigned long](https://webidl.spec.whatwg.org/#idl-unsigned-long) `numberOfFrames`;
  \[[EnforceRange](https://webidl.spec.whatwg.org/#EnforceRange)\] required [unsigned long](https://webidl.spec.whatwg.org/#idl-unsigned-long) `numberOfChannels`;
  ...
  required [BufferSource](https://webidl.spec.whatwg.org/#BufferSource) `data`;
...
1.  For all named fields in dataHolder, assign the value of each named field to the [AudioData](https://www.w3.org/TR/webcodecs/#audiodata) internal slot in value with the same name as the named field.
...
3.  Let resource be the [media resource](https://www.w3.org/TR/webcodecs/#media-resource) referenced by value’s [[[resource reference]]](https://www.w3.org/TR/webcodecs/#dom-audiodata-resource-reference-slot).
4.  Let newReference be a new reference to resource.
5.  Assign newReference to |serialized.resource reference|.
6.  For all remaining [AudioData](https://www.w3.org/TR/webcodecs/#audiodata) internal slots (excluding [[[resource reference]]](https://www.w3.org/TR/webcodecs/#dom-audiodata-resource-reference-slot)) in value, assign the value of each internal slot to a field in serialized with the same name as the internal slot.
...
1.  For all named fields in serialized, assign the value of each named field to the [AudioData](https://www.w3.org/TR/webcodecs/#audiodata) internal slot in value with the same name as the named field.

#### 9.2.7. AudioDataCopyToOptions[](https://www.w3.org/TR/webcodecs/#audiodata-copy-to-options)

```webidl
dictionary `AudioDataCopyToOptions` {
  \[[EnforceRange](https://webidl.spec.whatwg.org/#EnforceRange)\] required [unsigned long](https://webidl.spec.whatwg.org/#idl-unsigned-long) [planeIndex](https://www.w3.org/TR/webcodecs/#dom-audiodatacopytooptions-planeindex);
  \[[EnforceRange](https://webidl.spec.whatwg.org/#EnforceRange)\] [unsigned long](https://webidl.spec.whatwg.org/#idl-unsigned-long) [frameOffset](https://www.w3.org/TR/webcodecs/#dom-audiodatacopytooptions-frameoffset) = 0;
  \[[EnforceRange](https://webidl.spec.whatwg.org/#EnforceRange)\] [unsigned long](https://webidl.spec.whatwg.org/#idl-unsigned-long) [frameCount](https://www.w3.org/TR/webcodecs/#dom-audiodatacopytooptions-framecount);
  [AudioSampleFormat](https://www.w3.org/TR/webcodecs/#enumdef-audiosampleformat) [format](https://www.w3.org/TR/webcodecs/#dom-audiodatacopytooptions-format);
};
```
...
enum `AudioSampleFormat` {
  ...
  ["u8-planar"](https://www.w3.org/TR/webcodecs/#dom-audiosampleformat-u8-planar),
  ["s16-planar"](https://www.w3.org/TR/webcodecs/#dom-audiosampleformat-s16-planar),
  ["s32-planar"](https://www.w3.org/TR/webcodecs/#dom-audiosampleformat-s32-planar),
  ["f32-planar"](https://www.w3.org/TR/webcodecs/#dom-audiosampleformat-f32-planar),
};
```
...
interface `VideoFrame` {
  [constructor](https://www.w3.org/TR/webcodecs/#dom-videoframe-videoframe)([CanvasImageSource](https://html.spec.whatwg.org/multipage/canvas.html#canvasimagesource) `image`, optional [VideoFrameInit](https://www.w3.org/TR/webcodecs/#dictdef-videoframeinit) `init` = {});
  [constructor](https://www.w3.org/TR/webcodecs/#dom-videoframe-videoframe-data-init)([AllowSharedBufferSource](https://webidl.spec.whatwg.org/#AllowSharedBufferSource) `data`, [VideoFrameBufferInit](https://www.w3.org/TR/webcodecs/#dictdef-videoframebufferinit) `init`);

  readonly attribute [VideoPixelFormat](https://www.w3.org/TR/webcodecs/#enumdef-videopixelformat)? [format](https://www.w3.org/TR/webcodecs/#dom-videoframe-format);
  readonly attribute [unsigned long](https://webidl.spec.whatwg.org/#idl-unsigned-long) [codedWidth](https://www.w3.org/TR/webcodecs/#dom-videoframe-codedwidth);
  readonly attribute [unsigned long](https://webidl.spec.whatwg.org/#idl-unsigned-long) [codedHeight](https://www.w3.org/TR/webcodecs/#dom-videoframe-codedheight);
  readonly attribute [DOMRectReadOnly](https://www.w3.org/TR/geometry-1/#domrectreadonly)? [codedRect](https://www.w3.org/TR/webcodecs/#dom-videoframe-codedrect);
  readonly attribute [DOMRectReadOnly](https://www.w3.org/TR/geometry-1/#domrectreadonly)? [visibleRect](https://www.w3.org/TR/webcodecs/#dom-videoframe-visiblerect);
  readonly attribute [double](https://webidl.spec.whatwg.org/#idl-double) [rotation](https://www.w3.org/TR/webcodecs/#dom-videoframe-rotation);
  readonly attribute [boolean](https://webidl.spec.whatwg.org/#idl-boolean) [flip](https://www.w3.org/TR/webcodecs/#dom-videoframe-flip);
  readonly attribute [unsigned long](https://webidl.spec.whatwg.org/#idl-unsigned-long) [displayWidth](https://www.w3.org/TR/webcodecs/#dom-videoframe-displaywidth);
  readonly attribute [unsigned long](https://webidl.spec.whatwg.org/#idl-unsigned-long) [displayHeight](https://www.w3.org/TR/webcodecs/#dom-videoframe-displayheight);
  readonly attribute [unsigned long long](https://webidl.spec.whatwg.org/#idl-unsigned-long-long)? [duration](https://www.w3.org/TR/webcodecs/#dom-videoframe-duration);  // microseconds
  readonly attribute [long long](https://webidl.spec.whatwg.org/#idl-long-long) [timestamp](https://www.w3.org/TR/webcodecs/#dom-videoframe-timestamp);           // microseconds
  readonly attribute [VideoColorSpace](https://www.w3.org/TR/webcodecs/#videocolorspace) [colorSpace](https://www.w3.org/TR/webcodecs/#dom-videoframe-colorspace);

  [VideoFrameMetadata](https://www.w3.org/TR/webcodecs/#dictdef-videoframemetadata) [metadata](https://www.w3.org/TR/webcodecs/#dom-videoframe-metadata)();

  [unsigned long](https://webidl.spec.whatwg.org/#idl-unsigned-long) [allocationSize](https://www.w3.org/TR/webcodecs/#dom-videoframe-allocationsize)(
      optional [VideoFrameCopyToOptions](https://www.w3.org/TR/webcodecs/#dictdef-videoframecopytooptions) `options` = {});
  [Promise](https://webidl.spec.whatwg.org/#idl-promise)<[sequence](https://webidl.spec.whatwg.org/#idl-sequence)<[PlaneLayout](https://www.w3.org/TR/webcodecs/#dictdef-planelayout)\>> [copyTo](https://www.w3.org/TR/webcodecs/#dom-videoframe-copyto)(
      [AllowSharedBufferSource](https://webidl.spec.whatwg.org/#AllowSharedBufferSource) `destination`,
      optional [VideoFrameCopyToOptions](https://www.w3.org/TR/webcodecs/#dictdef-videoframecopytooptions) `options` = {});
  [VideoFrame](https://www.w3.org/TR/webcodecs/#videoframe) [clone](https://www.w3.org/TR/webcodecs/#dom-videoframe-clone)();
  [undefined](https://webidl.spec.whatwg.org/#idl-undefined) [close](https://www.w3.org/TR/webcodecs/#dom-videoframe-close)();
};

dictionary `VideoFrameInit` {
  [unsigned long long](https://webidl.spec.whatwg.org/#idl-unsigned-long-long) `duration`;  // microseconds
  [long long](https://webidl.spec.whatwg.org/#idl-long-long) `timestamp`;          // microseconds
  [AlphaOption](https://www.w3.org/TR/webcodecs/#enumdef-alphaoption) `alpha` = "keep";

  // Default matches image. May be used to efficiently crop. Will trigger
  // new computation of displayWidth and displayHeight using image's pixel
  // aspect ratio unless an explicit displayWidth and displayHeight are given.
  [DOMRectInit](https://www.w3.org/TR/geometry-1/#dictdef-domrectinit) `visibleRect`;

  [double](https://webidl.spec.whatwg.org/#idl-double) `rotation` = 0;
  [boolean](https://webidl.spec.whatwg.org/#idl-boolean) `flip` = false;

  // Default matches image unless visibleRect is provided.
  \[[EnforceRange](https://webidl.spec.whatwg.org/#EnforceRange)\] [unsigned long](https://webidl.spec.whatwg.org/#idl-unsigned-long) `displayWidth`;
  \[[EnforceRange](https://webidl.spec.whatwg.org/#EnforceRange)\] [unsigned long](https://webidl.spec.whatwg.org/#idl-unsigned-long) `displayHeight`;

  [VideoFrameMetadata](https://www.w3.org/TR/webcodecs/#dictdef-videoframemetadata) `metadata`;
};

dictionary `VideoFrameBufferInit` {
  required [VideoPixelFormat](https://www.w3.org/TR/webcodecs/#enumdef-videopixelformat) `format`;
  required \[[EnforceRange](https://webidl.spec.whatwg.org/#EnforceRange)\] [unsigned long](https://webidl.spec.whatwg.org/#idl-unsigned-long) `codedWidth`;
  required \[[EnforceRange](https://webidl.spec.whatwg.org/#EnforceRange)\] [unsigned long](https://webidl.spec.whatwg.org/#idl-unsigned-long) `codedHeight`;
  required \[[EnforceRange](https://webidl.spec.whatwg.org/#EnforceRange)\] [long long](https://webidl.spec.whatwg.org/#idl-long-long) `timestamp`;  // microseconds
  ...
  [sequence](https://webidl.spec.whatwg.org/#idl-sequence)<[PlaneLayout](https://www.w3.org/TR/webcodecs/#dictdef-planelayout)\> `layout`;
  ...
  [VideoColorSpaceInit](https://www.w3.org/TR/webcodecs/#dictdef-videocolorspaceinit) `colorSpace`;

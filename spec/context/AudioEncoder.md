...
AudioEncoder interface from the W3C WebCodecs specification.
...
1. [Enqueues a control message](#enqueues-a-control-message) to configure the audio encoder for encoding audio data as described by config.
...
9. [Running a control message](#running-a-control-message) to configure the encoder means performing these steps:
...
1. [Enqueues a control message](#enqueues-a-control-message) to encode the given data.
...
9. [Running a control message](#running-a-control-message) to encode the data means performing these steps:
...
2. When invoked, run the [Reset AudioEncoder](#reset-audioencoder) algorithm with an `[AbortError](https://webidl.spec.whatwg.org/#aborterror)` `[DOMException](https://webidl.spec.whatwg.org/#idl-DOMException)`.
...
2. When invoked, run the [Close AudioEncoder](#close-audioencoder) algorithm with an `[AbortError](https://webidl.spec.whatwg.org/#aborterror)` `[DOMException](https://webidl.spec.whatwg.org/#idl-DOMException)`.
